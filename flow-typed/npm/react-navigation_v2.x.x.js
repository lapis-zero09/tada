// flow-typed signature: e6281c77cee1e49c93d14425df3bd030
// flow-typed version: 5251ac53b8/react-navigation_v2.x.x/flow_>=v0.60.x
...
declare module 'react-navigation' {
  ...
  declare type StyleObj = null | void | number | false | '' | $ReadOnlyArray<StyleObj> | { [name: string]: any }
  ...
  declare export type NavigationRoute = NavigationLeafRoute | NavigationStateRoute
  ...
  declare export type NavigationStateRoute = NavigationLeafRoute & NavigationState
  ...
  declare export type NavigationScreenComponent<Route: NavigationRoute, Options: {}, Props: {}> = React$ComponentType<{
    ...Props,
    ...NavigationNavigatorProps<Options, Route>,
  }> &
    ({} | { navigationOptions: NavigationScreenConfig<Options> })

  declare export type NavigationNavigator<State: NavigationState, Options: {}, Props: {}> = React$ComponentType<{
    ...Props,
  ...
  declare export type NavigationTabScreenOptions = {|
    ...
    tabBarIcon?: React$Node | ((options: { tintColor: ?string, focused: boolean }) => ?React$Node),
    tabBarLabel?: string | React$Node | ((options: { tintColor: ?string, focused: boolean }) => ?React$Node),
  ...
  declare export type NavigationDrawerScreenOptions = {|
    ...$Exact<NavigationScreenOptions>,
    drawerIcon?: React$Node | ((options: { tintColor: ?string, focused: boolean }) => ?React$Node),
    drawerLabel?: React$Node | ((options: { tintColor: ?string, focused: boolean }) => ?React$Node),
  ...
  declare export type NavigationDispatch = (action: NavigationAction) => boolean
  ...
  declare export type EventType = 'willFocus' | 'didFocus' | 'willBlur' | 'didBlur' | 'action'
  ...
  declare export type NavigationEventCallback = (payload: NavigationEventPayload) => void
  ...
  declare export type NavigationScreenProp<+S> = {
    ...$ObjMap<_DefaultActionCreators, <Args>((...args: Args) => *) => (...args: Args) => boolean>,
    +state: S,
    dispatch: NavigationDispatch,
    addListener: (eventName: string, callback: NavigationEventCallback) => NavigationEventSubscription,
  ...
  declare export type NavigationContainer<State: NavigationState, Options: {}, Props: {}> = React$ComponentType<{
    ...Props,
  ...
  declare export type NavigationStyleInterpolator = (props: NavigationSceneRendererProps) => AnimatedViewStyleProp
  ...
  |}
  declare export function getNavigationActionCreators(route: NavigationRoute | NavigationState): _DefaultActionCreators
  ...
  declare type _TabViewConfig = {|
    ...
    configureTransition?: (currentTransitionProps: Object, nextTransitionProps: Object) => Object,
